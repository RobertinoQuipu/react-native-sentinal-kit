    ...
    async evaluate(ctx) {
        ...
        if (Native && typeof Native.profile === 'function') {
            ...
            return {
                ...
                native: true,
                signals: [
                    (0, types_1.signal)('riskRating', `Risk rating: ${res.riskRating}`, highRisk, 45),
                    (0, types_1.signal)('vpn', 'VPN detected', res.vpn, 10),
                    (0, types_1.signal)('proxy', 'Proxy detected', res.proxy, 12),
                    (0, types_1.signal)('tor', 'TOR exit node', res.tor, 25),
                    (0, types_1.signal)('emulator', 'Emulator', res.emulator, 15),
                    ...res.reasons.map((r, i) => (0, types_1.signal)(`reason-${i}`, r, true, 8)),
                ],
            };
        }
        ...
        if (!cfg.sandbox && (tmx === null || tmx === void 0 ? void 0 : tmx.baseUrl) && tmx.apiKey) {
            try {
                const sessionId = `mdl-${Date.now()}`;
                ...
                return {
                    ...
                    native: true,
                    signals: [
                        (0, types_1.signal)('riskRating', `Risk rating: ${res.risk_rating}`, highRisk, 45),
                        (0, types_1.signal)('vpn', 'VPN detected', (_a = res.vpn) !== null && _a !== void 0 ? _a : false, 10),
                        (0, types_1.signal)('proxy', 'Proxy detected', (_b = res.proxy) !== null && _b !== void 0 ? _b : false, 12),
                        (0, types_1.signal)('tor', 'TOR exit node', (_c = res.tor) !== null && _c !== void 0 ? _c : false, 25),
                        (0, types_1.signal)('emulator', 'Emulator', (_d = res.emulator) !== null && _d !== void 0 ? _d : false, 15),
                        ...((_e = res.reasons) !== null && _e !== void 0 ? _e : []).map((r, i) => (0, types_1.signal)(`reason-${i}`, r, true, 8)),
                    ],
                };
            }
            catch (err) {
        ...
        return {
            ...
            native: false,
            signals: [
                (0, types_1.signal)('riskRating', `Risk rating: ${rating}`, highRisk, 45),
                (0, types_1.signal)('vpn', 'VPN detected', network.vpn, 10),
                (0, types_1.signal)('proxy', 'Proxy detected', network.proxy, 12),
                (0, types_1.signal)('tor', 'TOR exit node', network.dnsChanged && network.proxy, 25),
                (0, types_1.signal)('emulator', 'Emulator', device.emulator || device.simulator, 15),
                (0, types_1.signal)('botSignature', 'Bot / automation signature', runtime.hookDetected, 20),
            ],
        };
    },
};
