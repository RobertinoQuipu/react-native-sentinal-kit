...
const deviceCollector_1 = require("./deviceCollector");
...
class SecurityKitImpl {
    ...
    get hasLiveSignals() {
        return (0, deviceCollector_1.hasLiveSignals)();
    }
    /**
    ...
    async scan() {
        ...
        if (!this.forceSimulation && (0, deviceCollector_1.hasLiveSignals)()) {
            this.lastMode = 'live';
            return (0, deviceCollector_1.collectLiveReport)();
        }
        // Simulated fallback (adds a little latency for UI scanning states).
        this.lastMode = 'simulated';
        await delay(300);
        const { device, runtime, network, integrity, privacy, remoteAccess } = this.activeProfile;
        const partial = {
            device,
            runtime,
            network,
...
if (!(0, exports.isNativeModuleAvailable)() && (0, platform_1.isDev)()) {
